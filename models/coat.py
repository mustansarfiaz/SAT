...
class COAT(nn.Module):
    def __init__(self, cfg):
        ...
        _, box_head = build_resnet(name="resnet50", pretrained=True)
        
        _, box_head_2nd = build_resnet(name="resnet50", pretrained=True)
        ...
        box_predictor2 = BBoxRegressor(2048, num_classes=2, bn_neck=cfg.MODEL.ROI_HEAD.BN_NECK)
...
class CascadedROIHeads(RoIHeads):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.box_predictor_3rd = box_predictor2#deepcopy(self.box_predictor)
        ...
        self.embedding_head_2nd_class = NormAwareEmbedding(featmap_names=["before_trans", "after_trans"], in_channels=[1024, 2048], dim=embedding_dim)
        ...
        self.reid_loss_3rd = OIMLoss(embedding_dim, num_pids, num_cq_size, oim_momentum, oim_scalar)#deepcopy(self.reid_loss_2nd)
    ...
    def forward(self, features, boxes, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        _, box_cls_scores_2nd = self.embedding_head_2nd_class(box_features)
        ...
        _, box_cls_scores_3rd = self.embedding_head_3rd_class(box_features)        
